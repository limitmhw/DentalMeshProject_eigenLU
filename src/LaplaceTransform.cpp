...
//LTransform::LTransform(std::string Mesh_Path_Open,std::string Mesh_Path_Save,std::string Limit_Ponit_Path,int Ww,double Ff):spMat(1156,1156),spMat_V(1156,3),spMat_U(1156,3),spMat_L(1156,1156),spMat_C(1156,1156),spMat_F(1156,1156){
